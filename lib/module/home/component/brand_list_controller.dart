...
class BrandListContainer extends StatefulWidget {
  const BrandListContainer({super.key, required this.brandModelList, required this.title, required this.onPressed});
  final List<BrandModel> brandModelList;
  final String title;
  final Function onPressed;
  @override
  State<BrandListContainer> createState() => _BrandListContainerState();
}

class _BrandListContainerState extends State<BrandListContainer> {
  @override
        ...
        children: [
          ...
          SliverLayoutBuilder(
            builder: (context,constraints){
              if (widget.brandModelList.isNotEmpty) {
                return SliverList(
                    ...
                    [
                      SizedBox(
                        ...
                        child: ListView.separated(
                          ...
                          itemCount: widget.brandModelList.length,
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () {
                                Navigator.pushNamed(context, RouteNames.productScreen,
                                    arguments: ProductsScreenArguments('','',widget.brandModelList[index].brandSiNo,''));
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    CircleAvatar(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: CustomImage(
                                          ...
                                          path: widget.brandModelList[index].image !=
                                              ''
                                              ? "${RemoteUrls.rootUrl}uploads/apps/${widget.brandModelList[index].image}"
                                              : null,
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ...
                                    SizedBox(
                                      child: Text(
                                        widget.brandModelList[index].brandName,
                                        maxLines: 1,
